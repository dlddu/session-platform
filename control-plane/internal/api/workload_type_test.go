...
// The create wire contract validates immutable workload settings,
...
// Workload type and model are immutable for the session lifetime.
...
// The API-visible model remains fixed while snapshot access restores a
