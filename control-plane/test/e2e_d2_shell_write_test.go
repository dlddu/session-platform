...
// 검증 AC: AC-D2
//
// write = shell stdin: the payload is injected into the session shell's stdin and
// bash actually runs it, and the call returns without waiting for the command to
// finish.
//
